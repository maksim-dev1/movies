...
part of 'search_movies_http_api.dart';
...
class _SearchMoviesHttpApi implements SearchMoviesHttpApi {
  _SearchMoviesHttpApi(this._dio, {this.baseUrl, this.errorLogger});
